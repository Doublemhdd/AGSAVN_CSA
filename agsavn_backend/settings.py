...
ROOT_URLCONF = 'agsavn_backend.urls'
...
WSGI_APPLICATION = 'agsavn_backend.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    'TITLE': 'AGSAVN CSA API',
    'DESCRIPTION': 'API for food security and nutrition indicators tracking platform',
    'VERSION': '1.0.0',
